...
PROVIDER_SECRET_PACKAGE = [
    ("azure_openai", "AZURE_OPENAI_API_KEY", "langchain_openai"),
...
PROVIDER_TO_MODELS = {
    "azure_openai": ["azure_openai/HKP-gpt-4o"],
}
...
def create_configurable(toolbox: tools.Toolbox) -> None:
    ...
    class Config:
        ...
        enable_memory: bool = field(
            default=True,
            metadata={
                "description": "Enable short-term memory for the agent to maintain conversation context. "
                "When enabled, the agent will remember previous interactions within the conversation thread."
            },
        )
